...
export const jqueryFuntion = () => {
  $(window).on("load", function () {
    ...
    // Use defensive widths (0 when element is missing) so removing sections won't break calculations
    var homewidth = ($(".home").width() || 0) - 10;
    var aboutwidth = homewidth + ($(".about").width() || 0) - 10;
    var portfoliowidth =
      aboutwidth +
      (($(".portfolio .single-item .main-content").width() || 0) +
        ...
        ($(".clients").width() || 0)) -
      10;
    var contactwidth = portfoliowidth + ($(".contact").width() || 0) - 10;
